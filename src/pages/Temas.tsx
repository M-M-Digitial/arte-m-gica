...
const themes = [
  { id: 1, name: "Safari", category: "Infantil", image: themeSafari, colors: ["#F4A460", "#8B4513", "#228B22", "#FFD700"], trending: true },
  { id: 2, name: "Unicórnio", category: "Infantil", image: themeUnicornio, colors: ["#FFB6C1", "#DDA0DD", "#87CEEB", "#F0E68C"], trending: true },
  { id: 3, name: "Princesas", category: "Infantil", image: themePrincesas, colors: ["#FFB7C5", "#FFD700", "#E6E6FA", "#FFF0F5"], trending: true },
  { id: 4, name: "Fazendinha", category: "Infantil", image: themeFazendinha, colors: ["#8B4513", "#228B22", "#FFD700", "#FF6347"], trending: false },
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-6xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {filtered.map((theme) => {
          const hasImage = 'image' in theme && theme.image;
          return (
              ...
              <CardContent className="p-0">
                <div className="h-40 bg-card flex items-center justify-center relative overflow-hidden p-2">
                  {hasImage ? (
                    ...
                    <span className="text-5xl group-hover:scale-110 transition-transform">{'emoji' in theme ? (theme as any).emoji : '🎉'}</span>
                  )}
                  {theme.trending && (
